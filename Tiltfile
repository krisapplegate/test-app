...
custom_build('index.docker.io/kapplegate/tap-dev/tanzu-java-web-app',
...
tanzu_k8s_yaml('tanzu-java-web-app', 'index.docker.io/kapplegate/tap-dev/tanzu-java-web-app', './config/workload.yaml')
